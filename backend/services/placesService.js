...
const autocompleteSearch = async (input) => {
  try {
    ...
    console.log('RapidAPI Autocomplete response status:', response.status)
    ...
    // Return fallback suggestions for common places
    return [
      { description: input, mainText: input, secondaryText: '' }
    ]
  }
}
